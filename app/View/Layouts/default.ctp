        ...
        <div id="container">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="">Show </a>
                        <ul>
                            <li><?php echo $this->Html->link('Show persons',array('controller'=>'persons/paging','action'=>'index'))?> </li>
                            <li><?php echo $this->Html->link('Show pets',array('controller'=>'pets/paging','action'=>'index'))?> </li>
